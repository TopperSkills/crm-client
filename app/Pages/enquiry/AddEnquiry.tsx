    ...
    <div className="w-full min-h-[calc(100vh-64px)] bg-[#F4F8F7] px-4 sm:px-6 lg:px-10 py-10">
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl border border-[#B2DFDB] shadow-lg p-6 sm:p-8">
        ...
        >
          ...
          {/* Enquiry Details */}
          <div className="pt-5 border-t border-[#B2DFDB]">
            <h2 className="text-xl font-bold text-[#263238]">
              Enquiry Details
            </h2>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#F8FAFA] border border-[#B2DFDB] rounded-lg px-4 py-3 text-[#263238] outline-none resize-none placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-[#80CBC4]/40 focus:border-[#4F9D95] transition"
              {...register("message", {
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-[#B2DFDB]">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto bg-[#263238] hover:bg-[#37474F] text-white font-semibold px-6 py-3 rounded-lg shadow-sm hover:shadow-md transition"
            >
              Update Enquiry
            </button>
